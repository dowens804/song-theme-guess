...
class AZLyrics(Proxy_Checker):
    def __init__(self):
        Proxy_Checker.__init__(self, "azlyrics", 'https://www.azlyrics.com/')
        self.base_url = 'https://www.azlyrics.com/'
        self.url_max_retrires = 5
        self.max_retries = 5
        self.max_workers = 100
        self.timeout = 10
        self.az_link_data = 'data_to_scrap.json'
        self.az_link_lyrics = 'data_lyrics.json'
        self.az_load_data()
        self.az_logger()
    ...
    def lyrics_from_link(self , link):
        if '../' in link:
            ...
            temp_link = self.base_url + link[1:]
        else :
            temp_link = link
...
if __name__ == "__main__":
    ...
    #az_lyrics = AZLyrics()
    '''az_lyrics.add_urls(['https://www.azlyrics.com/b/benjamin.html',
                        'https://www.azlyrics.com/k/knowles.html',
                        'https://www.azlyrics.com/f/franksinatra.html',
                        'https://www.azlyrics.com/t/techn9ne.html',
                        'https://www.azlyrics.com/c/cosmosheldrake.html',
                        'https://www.azlyrics.com/j/jackson.html'
                        ])
    #az_lyrics.az_songs_by_list("New")'''
    #az_lyrics.start_scrapping()